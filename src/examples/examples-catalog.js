(function(global) {
  ...
  const examples = [
    ...
    },
    {
      ...
      summary: "Formulario Kendo mestre-detalhe com cabecalho do pedido de venda e abas para itens e parcelas.",
      ...
      code: {
        ...
        master: {
          ...
          subtitle: "Cabecalho do pedido usado para editar os filhos.",
          idField: "id",
          displayField: "numero",
          fields: [
  ...
  if (pedidoVendaMasterDetailExample) {
    ...
    examples.splice(examples.indexOf(pedidoVendaMasterDetailExample) + 1, 0, {
      ...
      category: "Cadastro",
      title: "Pedido de venda com inclusao conjunta",
      summary: "Formulario mestre-detalhe onde a inclusao permite digitar cabecalho e filhos em rascunho e confirmar tudo em um endpoint transacional.",
  ...
  const propertyOptions = [
    ...
    option("Mestre-detalhe", "master.fields[]", "{ id, label, type, required, readonly }", "vazio", "Campos renderizados no cabecalho do formulario do pai."),
    ...
    option("Filtro", "crud.filter.fields[].frequentEndpoint", "endpointId | endpoint ref", "vazio", "No `searchWindow`, permite buscar do backend a lista de registros mais usados por usuario/tela/filtro ao acionar o botao `Mais usados`."),
    option("Filtro", "crud.filter.fields[].frequentRecordEndpoint", "endpointId | endpoint ref", "recordLookupUsage quando existir em dataSource.api", "No `searchWindow`, envia ao backend os registros selecionados para persistir frequencia em tabela por usuario/tela/filtro."),
