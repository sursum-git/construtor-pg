...
- `production/app.html`: entrada de producao por `screenId`, cobrindo `crud`, `master_detail`, `process`, `custom`, `analytics`, `report`, `special_document` e `regulated_document`.
